...
public class SubjectP implements org.apache.thrift.TBase<SubjectP, SubjectP._Fields>, java.io.Serializable, Cloneable, Comparable<SubjectP> {
  ...
  public SubjectP setId(String id) {
    this.id = id;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributeValues = new ArrayList<AttributeValueP>(_list32.size);
                for (int _i33 = 0; _i33 < _list32.size; ++_i33)
                {
                  AttributeValueP _elem34;
                  _elem34 = new AttributeValueP();
                  _elem34.read(iprot);
                  struct.attributeValues.add(_elem34);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SubjectP struct) throws org.apache.thrift.TException {
      ...
      if (struct.attributeValues != null) {
        oprot.writeFieldBegin(ATTRIBUTE_VALUES_FIELD_DESC);
        {
          ...
          for (AttributeValueP _iter35 : struct.attributeValues)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetAttributeValues()) {
        {
          ...
          for (AttributeValueP _iter36 : struct.attributeValues)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.attributeValues = new ArrayList<AttributeValueP>(_list37.size);
          for (int _i38 = 0; _i38 < _list37.size; ++_i38)
          {
            AttributeValueP _elem39;
            _elem39 = new AttributeValueP();
            _elem39.read(iprot);
            struct.attributeValues.add(_elem39);
          }
        }
        struct.setAttributeValuesIsSet(true);
      }
