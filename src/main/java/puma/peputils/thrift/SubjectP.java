...
public class SubjectP implements org.apache.thrift.TBase<SubjectP, SubjectP._Fields>, java.io.Serializable, Cloneable, Comparable<SubjectP> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SubjectP");
  ...
  static {
    schemes.put(StandardScheme.class, new SubjectPStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SubjectPTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SubjectP.class, metaDataMap);
  }
   ...
   */
  public SubjectP(SubjectP other) {
  ...
  public SubjectP deepCopy() {
    return new SubjectP(this);
  }
  ...
  public SubjectP setAttributeValues(List<AttributeValueP> attributeValues) {
    this.attributeValues = attributeValues;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SubjectP)
      return this.equals((SubjectP)that);
    return false;
  }

  public boolean equals(SubjectP that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SubjectP other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SubjectP(");
    boolean first = true;
  ...
  private static class SubjectPStandardSchemeFactory implements SchemeFactory {
    public SubjectPStandardScheme getScheme() {
      return new SubjectPStandardScheme();
    }
  }

  private static class SubjectPStandardScheme extends StandardScheme<SubjectP> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SubjectP struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributeValues = new ArrayList<AttributeValueP>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  AttributeValueP _elem2;
                  _elem2 = new AttributeValueP();
                  _elem2.read(iprot);
                  struct.attributeValues.add(_elem2);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SubjectP struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.attributeValues != null) {
        oprot.writeFieldBegin(ATTRIBUTE_VALUES_FIELD_DESC);
        {
          ...
          for (AttributeValueP _iter3 : struct.attributeValues)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class SubjectPTupleSchemeFactory implements SchemeFactory {
    public SubjectPTupleScheme getScheme() {
      return new SubjectPTupleScheme();
    }
  }

  private static class SubjectPTupleScheme extends TupleScheme<SubjectP> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SubjectP struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetAttributeValues()) {
        {
          ...
          for (AttributeValueP _iter4 : struct.attributeValues)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SubjectP struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(1);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list5 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.attributeValues = new ArrayList<AttributeValueP>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            AttributeValueP _elem7;
            _elem7 = new AttributeValueP();
            _elem7.read(iprot);
            struct.attributeValues.add(_elem7);
          }
        }
        struct.setAttributeValuesIsSet(true);
      }
