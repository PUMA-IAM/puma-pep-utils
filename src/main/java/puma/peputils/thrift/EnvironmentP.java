...
public class EnvironmentP implements org.apache.thrift.TBase<EnvironmentP, EnvironmentP._Fields>, java.io.Serializable, Cloneable, Comparable<EnvironmentP> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("EnvironmentP");
  ...
  static {
    schemes.put(StandardScheme.class, new EnvironmentPStandardSchemeFactory());
    schemes.put(TupleScheme.class, new EnvironmentPTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(EnvironmentP.class, metaDataMap);
  }
   ...
   */
  public EnvironmentP(EnvironmentP other) {
  ...
  public EnvironmentP deepCopy() {
    return new EnvironmentP(this);
  }
  ...
  public EnvironmentP setAttributeValues(List<AttributeValueP> attributeValues) {
    this.attributeValues = attributeValues;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof EnvironmentP)
      return this.equals((EnvironmentP)that);
    return false;
  }

  public boolean equals(EnvironmentP that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(EnvironmentP other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("EnvironmentP(");
    boolean first = true;
  ...
  private static class EnvironmentPStandardSchemeFactory implements SchemeFactory {
    public EnvironmentPStandardScheme getScheme() {
      return new EnvironmentPStandardScheme();
    }
  }

  private static class EnvironmentPStandardScheme extends StandardScheme<EnvironmentP> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, EnvironmentP struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EnvironmentP struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class EnvironmentPTupleSchemeFactory implements SchemeFactory {
    public EnvironmentPTupleScheme getScheme() {
      return new EnvironmentPTupleScheme();
    }
  }

  private static class EnvironmentPTupleScheme extends TupleScheme<EnvironmentP> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, EnvironmentP struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, EnvironmentP struct) throws org.apache.thrift.TException {
